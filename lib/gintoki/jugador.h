#ifndef JUGADOR_H
#define JUGADOR_H
#include "../gaming/dynamic_object.hpp"
...
class Jugador: public Gaming::DynamicObject{
  private:
    static int automata[];
    static Image* automata_r[];
  ...
  public:
    ...
    bool estaCayendo();
    bool estaGolpeando();
    Jugador(const _2D::Rectangulo<double>& pos, Color f = Color::black , const _2D::Punto<double> v = _2D::Punto<double>(), const _2D::Punto<double> a = _2D::Punto<double>()):Gaming::DynamicObject(pos, GINTOKI_STAND1, f, v, a){
...
void Jugador::dibujar(){
  Gaming::DynamicObject::dibujar(orientacion_ == IZQUIERDA);
